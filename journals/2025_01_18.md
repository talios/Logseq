...
- **17:41** [[SMX3]] Integration Tests for *Shared Services* working, and passing along with various backend changes to resolve the issue, I should however run the test against the unfixed code.
  ...
  It's interesting revisiting the IT test code base to actually add new tests, it's somewhat over-engineered and a bit messy (mixing raw TestNG, Concordion, *and* JBehave tests) but it works.
-